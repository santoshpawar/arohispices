<!--
Author: http://7patterns.in/
Author URL: http://7patterns.in/
...
<html>
<head>
<title>Spicy Aarohi a Hotel Category Flat Bootstrap Responsive Website Template | Codes :: http://7patterns.in/</title>
<!--mobile apps-->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Spicy Aarohi Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<body>
	...
	<div class="banner about-banner">
		<div class="container">
			...
			<div class="header">
				<div class="logo">
					<h1 class="wow zoomIn animated" data-wow-delay=".5s"><a href="index.php">Spicy Aarohi</a></h1>
				</div>
				<div class="top-nav">
					...
					<ul>
						...
						<li class="wow slideInDown animated" data-wow-delay=".7s"><a class="active" href="codes.php">Codes</a></li>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-copy wow slideInUp animated" data-wow-delay=".5s">
				<p>© 2016 Spicy Aarohi. All rights reserved | Design by <a href="http://7patterns.in/">http://7patterns.in/</a></p>
			</div>
		</div>	
	</div>	
	<!--//footer-->	
